...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x4387;
...
const int      P2P_DEFAULT_PORT                              = 17840;
const int      RPC_DEFAULT_PORT                              = 18200;
...
// checkpoints using the following format:
